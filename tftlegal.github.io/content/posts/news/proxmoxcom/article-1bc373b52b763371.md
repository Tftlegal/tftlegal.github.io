...
summary: "17 ноября 2021 года Proxmox выпустила версию 7.1 своей платформы управления виртуализацией Proxmox Virtual Environment.   Она построена на Debian Bullseye 11.1 и обновленных компонентах: QEMU 6.1, LXC 4.0, Ceph Pacific и ZFS 2.1.   Среди ключевых новинок — поддержка Windows 11 с TPM 2.0, улучшенный мастер создания ВМ и контейнеров, гибкие политики хранения резервных копий и более гибкое планирование задач.   Также добавлены поддержка Fedora 35, Ubuntu 21.10, AlmaLinux и Rocky Linux для контейнеров, улучшенная двухфакторная аутентификация с WebAuthn и восстановление через одноразовые ключи.   Прочие улучшения включают упрощение создания гостей с несколькими дисками, поддержку нескольких CephFS-инстансов и возможность установки версии через APT-обновление.   Proxmox VE остается бесплатным open-source ПО, а компания предлагает платную подписку на поддержку и обновления для предприятий."
---
...
17 ноября 2021 года Proxmox выпустила версию 7.1 своей платформы управления виртуализацией Proxmox Virtual Environment.  
Она построена на Debian Bullseye 11.1 и обновленных компонентах: QEMU 6.1, LXC 4.0, Ceph Pacific и ZFS 2.1.  
Среди ключевых новинок — поддержка Windows 11 с TPM 2.0, улучшенный мастер создания ВМ и контейнеров, гибкие политики хранения резервных копий и более гибкое планирование задач.  
Также добавлены поддержка Fedora 35, Ubuntu 21.10, AlmaLinux и Rocky Linux для контейнеров, улучшенная двухфакторная аутентификация с WebAuthn и восстановление через одноразовые ключи.  
Прочие улучшения включают упрощение создания гостей с несколькими дисками, поддержку нескольких CephFS-инстансов и возможность установки версии через APT-обновление.  
Proxmox VE остается бесплатным open-source ПО, а компания предлагает платную подписку на поддержку и обновления для предприятий.
