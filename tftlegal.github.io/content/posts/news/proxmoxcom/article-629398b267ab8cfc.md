...
summary: "Компания Proxmox объявила о выпуске версии 3.1 своего открытого решения Proxmox Backup Server. Продукт предназначен для резервного копирования и восстановления виртуальных машин, контейнеров и физических хостов, поддерживая инкрементальные бэкапы, дедупликацию, сжатие Zstandard и аутентифицированное шифрование. В новой версии появилась поддержка Secure Boot, локальные синхронизационные задания, улучшенная совместимость с LTO 9 и перевод веб-интерфейса на хорватский и грузинский языки. Система построена на Debian 12.2 «Bookworm» со стабильным ядром Linux 6.5 и включает ZFS 2.2.0 с важными исправлениями. Proxmox Backup Server 3.1 доступна для загрузки, может устанавливаться на bare-metal или поверх Debian, а обновления выполняются через APT. Программное обеспечение распространяется под лицензией GNU AGPLv3, а для корпоративных клиентов Proxmox предлагает подписку на поддержку, начиная с 495 евро за сервер."
---
...
Компания Proxmox объявила о выпуске версии 3.1 своего открытого решения Proxmox Backup Server. Продукт предназначен для резервного копирования и восстановления виртуальных машин, контейнеров и физических хостов, поддерживая инкрементальные бэкапы, дедупликацию, сжатие Zstandard и аутентифицированное шифрование. В новой версии появилась поддержка Secure Boot, локальные синхронизационные задания, улучшенная совместимость с LTO 9 и перевод веб-интерфейса на хорватский и грузинский языки. Система построена на Debian 12.2 «Bookworm» со стабильным ядром Linux 6.5 и включает ZFS 2.2.0 с важными исправлениями. Proxmox Backup Server 3.1 доступна для загрузки, может устанавливаться на bare-metal или поверх Debian, а обновления выполняются через APT. Программное обеспечение распространяется под лицензией GNU AGPLv3, а для корпоративных клиентов Proxmox предлагает подписку на поддержку, начиная с 495 евро за сервер.
